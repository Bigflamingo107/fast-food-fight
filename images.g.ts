...
`];
    ...
    helpers._registerFactory("song", function(name: string) {
        switch(helpers.stringTrim(name)) {
            case "song1":
            case "Mc song":return hex`0064000408080101001c000f05001202c102c201000405002800000064002800030500060000042b000000040001290400080002272a0c001000012410001400012014001800012018001c0001241c0020000127`;
        }
        return null;
    })
